...
const FinancexpencesView = () => {
    ...
    const handleDownloadPDF = () => {
        ...
        doc.text('Expense Transactions Report', 105, 30, { align: 'center' });
    ...
    return (
        <div className="flex min-h-screen">
            ...
            <div>
                <h1 className="text-3xl font-bold text-center mb-3">Recent Expense Transactions</h1>
                ...
                <div className="mb-5 p-5 bg-gray-100 rounded-lg border border-gray-200 text-center">  
                    <p className="text-base text-gray-800">
                        Total Number of Transactions: <strong className="text-blue-600">{totalTransactions}</strong>
                    </p>
                    <p className="text-base text-gray-800">
                        Total Amount: <strong className="text-blue-600">Rs. {totalAmount.toFixed(2)}</strong>
                    </p>
                </div>
                    ...
                    <tbody>
                        {transactions.map((transaction) => (
                            <tr key={transaction._id} className="hover:bg-gray-50">
                                ...
                                <td className="p-3 border-b border-gray-200">Rs. {transaction.amount}</td>
...
export default FinancexpencesView;